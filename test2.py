...
from tkinter import Label, Button, filedialog, messagebox, Frame, Toplevel, colorchooser
...
class QRCodeScannerApp:
    def __init__(self, root):
        ...
        self.generate_button.grid(row=0, column=2, padx=10, pady=5, sticky=tk.W+tk.E)
        ...
        self.qr_color_button.grid(row=0, column=3, padx=10, pady=5, sticky=tk.W+tk.E)
